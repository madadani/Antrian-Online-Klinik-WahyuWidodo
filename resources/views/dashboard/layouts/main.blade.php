...
<head>
    ...
    <title>Dashboard - Antrian Online Klinik</title>
    <meta content="" name="description">
    <meta content="" name="keywords">

    <!-- Favicons -->
    
    <link href="public/assets/img/apple-touch-icon.jpeg" rel="icon">
...
<body>
    ...
    <aside id="sidebar" class="sidebar">
        ...
        <ul class="sidebar-nav" id="sidebar-nav">
                ...
                <ul id="components-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                    ...
                    <li>
                        <a href="/dashboard/antrian/poliKia">
                            <i class="bi bi-circle"></i><span>Poli KIA </span>
                        </a>
                    </li>
                </ul>
            ...
            <!-- <li class="nav-item">
                <a class="nav-link collapsed" href="/dashboard/dokter/index">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="/dashboard/rekam-medis">
                    <i class="bx bx-plus-medical"></i>
    ...
    <footer id="footer" class="footer">
        <div class="copyright">
            &copy; Copyright <strong><span>klinik wahyu Widodo</span></strong>. All Rights Reserved
        </div>
        <div class="credits">
