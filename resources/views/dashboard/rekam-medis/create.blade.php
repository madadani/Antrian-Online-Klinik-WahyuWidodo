        ...
        <div class="container">
            <div class="card mt-3">
                <div class="card-body">
                    ...
                    <form action="/dashboard/rekam-medis" method="POST">
                        @csrf
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="no_ktp" class="form-control" value="{{ old('no_ktp') }}">
                                    @error('no_ktp')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="no_bpjs" class="form-control" value="{{ old('no_bpjs') }}">
                                    @error('no_bpjs')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="keluhan" class="form-control" cols="30" rows="5"></textarea>
                            @error('keluhan')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <button type="submit" class="btn btn-primary my-3 float-end">Simpan</button>
                    </form>
                </div>
            </div>
        </div>
