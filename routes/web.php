...
Route::middleware('auth')->group(function () {
    Route::group(['middleware' => 'CheckRole:admin'], function () {
        ...
        Route::get('/dashboard/rekam-medis/get-data', [DashboardRekamMedisController::class, 'getData']);
        Route::get('/dashboard/rekam-medis/print', [DashboardRekamMedisController::class, 'printData'])->name('printData');
        Route::resource('/dashboard/rekam-medis', DashboardRekamMedisController::class);
    });
});